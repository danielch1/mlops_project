...
def make_train_data():
    ...
    #defines the paths to function properly indepependent of the OS
...
def convert_label(label):
    meta_data = pd.read_csv(os.path.join(_PROJECT_ROOT,'data','external','lego_dataset','metadata.csv'))
